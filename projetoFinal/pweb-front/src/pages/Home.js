            ...
            <div>
                    ...
                    <div class="carousel slide" id="slider" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="assets/img/Imagens/banner-1.jpg" alt="Casa 1" class="d-block w-100" />
                            ...
                            <div class="carousel-item">
                                <img src="assets/img/Imagens/banner-2.jpg" alt="Casa 2" class="d-block w-100" />
                                <div class="carousel-caption">
                            ...
                            <div class="carousel-item">
                                <img src="assets/img/Imagens/banner-3.jpg" alt="Casa 3" class="d-block w-100" />
                                <div class="carousel-caption">
                ...
                <div class="container" id="features-conainer">
                    ...
                    <div class="col-12" id="featured-images">
                        <div class="row g-4">
                            <div class="col-12 col-md-4">
                                <img src="assets/img/Imagens/project-1.jpg" alt="Projeto 1" class="img.fluid" />
                            ...
                            <div class="col-12 col-md-4">
                                <img src="assets/img/Imagens/project-2.jpg" alt="Projeto 2" class="img.fluid" />
                                <div class="banner content">
                                    <p class="secondary-color">Categoria</p>
                                    <h3>Nome do projeto</h3>
                                </div>
                            ...
                            <div class="col-12 col-md-4">
                                <img src="assets/img/Imagens/project-3.jpg" alt="Projeto 3" class="img.fluid" />
                                <div class="banner content">
                                    <p class="secondary-color">Categoria</p>
                                    <h3>Nome do projeto</h3>
                                </div>
                            ...
                            <div class="col-12 col-md-4">
                                <img src="assets/img/Imagens/project-4.jpg" alt="Projeto 4" class="img.fluid" />
                                <div class="banner content">
                                    <p class="secondary-color">Categoria</p>
                                    <h3>Nome do projeto</h3>
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    <img src="assets/img/Imagens/project-5.jpg" alt="Projeto 5" class="img.fluid" />
                                    <div class="banner content">
                                        <p class="secondary-color">Categoria</p>
                                        <h3>Nome do projeto</h3>
                                    </div>
                                ...
                                <div class="col-12 col-md-4">
                                    <img src="assets/img/Imagens/project-6.jpg" alt="Projeto 6" class="img.fluid" />
                                    <div class="banner content">
                                        <p class="secondary-color">Categoria</p>
                                        <h3>Nome do projeto</h3>
                                    </div>
